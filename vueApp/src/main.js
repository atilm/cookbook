...
import RecipeCollectionDetailsView from './views/RecipeCollectionDetailsView.vue';
...
const routes = [
  ...
  { path: '/recipeCollection/:id/details', name: 'recipeCollectionDetails', component: RecipeCollectionDetailsView}
]
